...
@Entity
@Table(name = "repayment_frequency_his")
@Data
public class RepaymentFrequencyHistory extends BaseEntity implements Serializable {

	private static final long serialVersionUID = -9037106723972191908L;
