...
@Entity
@Table(name = "eligibility_branch_history")
public class EligibilityTemplateBranchHistory extends BaseEntity implements Serializable {

	private static final long serialVersionUID = -7363391435648398148L;

	@Column(name = "tenant_id", length = 10, nullable = false)
	private String tenantId;

	@Column(name = "eligibility_branch_id", nullable = false)
	private Long eligibilityBranchId;
...
//	@ManyToOne(fetch = FetchType.LAZY, cascade = CascadeType.MERGE)
	...
	public Long getEligibilityBranchId() {
		return eligibilityBranchId;
	}

	public void setEligibilityBranchId(Long eligibilityBranchId) {
