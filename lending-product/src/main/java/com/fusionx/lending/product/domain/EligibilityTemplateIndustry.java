...
@Entity
@Table(name = "eligibility_industry")
public class EligibilityTemplateIndustry extends BaseEntity implements Serializable {

	private static final long serialVersionUID = -8842508564193461012L;
