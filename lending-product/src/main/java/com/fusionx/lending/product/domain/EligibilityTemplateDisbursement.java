...
@Entity
@Table(name = "eligibility_disbursement")
public class EligibilityTemplateDisbursement extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 7027614478482667876L;
