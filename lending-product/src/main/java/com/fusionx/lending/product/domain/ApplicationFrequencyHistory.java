...
@Entity
@Data
@Table(name = "applicaction_frequency_his")
public class ApplicationFrequencyHistory extends BaseEntity implements Serializable{
	...
	@Column(name = "applicaction_frequency_id")
	...
	@Column(name = "applicaction_frequency_version")
	private Long applicactionFrequencyVersion;
	...
	public Long getApplicactionFrequencyId() {
		return applicactionFrequencyId;
	}

	public void setApplicactionFrequencyId(Long applicactionFrequencyId) {
		this.applicactionFrequencyId = applicactionFrequencyId;
	}
	...
	public Long getApplicactionFrequencyVersion() {
		return applicactionFrequencyVersion;
	}

	public void setApplicactionFrequencyVersion(Long applicactionFrequencyVersion) {
		this.applicactionFrequencyVersion = applicactionFrequencyVersion;
	}
