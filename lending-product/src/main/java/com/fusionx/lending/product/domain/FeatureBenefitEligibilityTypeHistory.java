...
/**
 * Feature Benefit Eligibility Type History Domain
 * 
 ********************************************************************************************************
...
@Entity
@Table(name = "feature_benefit_eligi_type_his")
@Data
public class FeatureBenefitEligibilityTypeHistory extends BaseEntity implements Serializable {
	...
	@Column(name="feature_benefit_eligi_type_id", nullable=false)
	private Long featureBenefitEligiTypeId;
	...
	public Long getFeatureBenefitEligiTypeId() {
		return featureBenefitEligiTypeId;
	}

	public void setFeatureBenefitEligiTypeId(Long featureBenefitEligiTypeId) {
		this.featureBenefitEligiTypeId = featureBenefitEligiTypeId;
	}
