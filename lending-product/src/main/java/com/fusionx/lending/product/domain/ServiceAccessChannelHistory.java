...
/**
 * Brand History Domain
 * 
 ********************************************************************************************************
 *  ###   Date         Story Point   Task No    Author       Description
 *-------------------------------------------------------------------------------------------------------
 *    1   09-06-2021      		     			Nipun Dilhan      Created
 *    
 ********************************************************************************************************
 */

@Entity
@Table(name = "service_access_channel_history")
@Data
public class ServiceAccessChannelHistory extends BaseEntity implements Serializable {
	...
	@Column(name="service_access_channel_id", nullable=false)
	private Long serviceAccessChannelId;
	...
	public void setServiceAccessChannelId(Long serviceAccessChannelId) {
