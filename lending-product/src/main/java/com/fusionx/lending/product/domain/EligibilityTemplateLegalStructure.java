...
@Entity
@Table(name = "eligibility_legal_structure")
public class EligibilityTemplateLegalStructure extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 402944012836400366L;
