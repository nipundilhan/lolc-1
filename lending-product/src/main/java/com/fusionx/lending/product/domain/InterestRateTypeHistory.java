...
@Entity
@Data
@Table(name = "interest_rate_type_history")
public class InterestRateTypeHistory extends BaseEntity implements Serializable {
	...
	@Column(name = "interest_rate_type_version")
	private Long interestRateTypeVersion;
	...
	public Long getInterestRateTypeVersion() {
		return interestRateTypeVersion;
	}

	public void setInterestRateTypeVersion(Long interestRateTypeVersion) {
		this.interestRateTypeVersion = interestRateTypeVersion;
	}
