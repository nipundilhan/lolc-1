...
@Entity
@Table(name = "eligibility_industry_history")
public class EligibilityTemplateIndustryHistory extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 8841306063940666788L;

	@Column(name = "tenant_id", length = 10, nullable = false)
	private String tenantId;

	@Column(name = "eligibility_industry_id", nullable = false)
	private Long eligibilityIndustryId;
...
//	@ManyToOne(fetch = FetchType.LAZY, cascade = CascadeType.MERGE)
	...
	public Long getEligibilityIndustryId() {
		return eligibilityIndustryId;
	}

	public void setEligibilityIndustryId(Long eligibilityIndustryId) {
