...
public class MasterDefAccRuleCommonListUpdateResource {

	@Pattern(regexp = "^$|[0-9]+", message = "{common-numeric.pattern}")
	private String masterDefAccountRuleSetStandardId;

	public String getMasterDefAccountRuleSetStandardId() {
	...
	public void setMasterDefAccountRuleSetStandardId(String masterDefAccountRuleSetStandardId) {
