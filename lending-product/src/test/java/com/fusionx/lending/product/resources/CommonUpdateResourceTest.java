...
/*    @Test
    public void descriptionSize() {
		...
		assertEquals("{common-length01.size}", TestUtils.getFieldErrorMessageKey(commonUpdateResource, localValidatorFactory));
...
/*    @Test
	public void versionNotNull() {
		...
		assertEquals("{version.not-null}", TestUtils.getFieldErrorMessageKey(commonUpdateResource, localValidatorFactory));
	}
...
/*    @Test
	public void versionPattern() {
		...
		assertEquals("{version.pattern}", TestUtils.getFieldErrorMessageKey(commonUpdateResource, localValidatorFactory));
	}
*/
}
