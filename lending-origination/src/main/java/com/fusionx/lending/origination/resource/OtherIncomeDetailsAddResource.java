...
public class OtherIncomeDetailsAddResource {
	...
	private List<DocumentAddResource> otherIncomeDocumentList;
	...
	public List<DocumentAddResource> getOtherIncomeDocumentList() {
		return otherIncomeDocumentList;
	}

	public void setOtherIncomeDocumentList(List<DocumentAddResource> otherIncomeDocumentList) {
