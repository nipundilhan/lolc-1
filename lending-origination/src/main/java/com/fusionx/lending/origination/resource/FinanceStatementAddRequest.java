...
public class FinanceStatementAddRequest {
...
//	private String auditByUserId;
	...
	@Valid
	private List<DocumentRefAddResource> documentList;


	public List<DocumentRefAddResource> getDocumentList() {
		return documentList;
	}

	public void setDocumentList(List<DocumentRefAddResource> documentList) {
