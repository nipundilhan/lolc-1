...
@Entity
@Table(name = "cultivation_income_type_history")
@Data
public class CultivationIncomeTypeHistory extends BaseEntity implements Serializable {
	...
	@Column(name = "cultivation_income_type_id", nullable = false)
	private Long cultivationIncomeTypeId;
	...
	public Long getCultivationIncomeTypeId() {
		return cultivationIncomeTypeId;
	}

	public void setCultivationIncomeTypeId(Long cultivationIncomeTypeId) {
		this.cultivationIncomeTypeId = cultivationIncomeTypeId;
	}
