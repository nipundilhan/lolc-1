...
@Entity
@Table(name = "risk_authorities_history")
@Data
public class RiskAuthoritiesHistory extends BaseEntity implements Serializable {
	...
	@Column(name = "risk_authorities_id", nullable = false)
	private Long riskAuthoritiesId;
	...
	public Long getRiskAuthoritiesId() {
		return riskAuthoritiesId;
	}

	public void setRiskAuthoritiesId(Long riskAuthoritiesId) {
		this.riskAuthoritiesId = riskAuthoritiesId;
	}
