...
public class ReferenceDetailsUpdateResource {
	...
	private List<ReferenceDetailsContactInfoUpdateResource> contactDetails;
	...
	public List<ReferenceDetailsContactInfoUpdateResource> getContactDetails() {
		return contactDetails;
	}

	public void setContactDetails(List<ReferenceDetailsContactInfoUpdateResource> contactDetails) {
