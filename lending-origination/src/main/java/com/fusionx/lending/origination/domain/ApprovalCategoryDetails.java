...
@Entity
@Table(name = "approval_category_details")
@Data
public class ApprovalCategoryDetails extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 231366424588016429L;
	...
	@Transient
	private List<ApprovalCategoryApplicableVariables> applicableVariables;
	...
	public List<ApprovalCategoryApplicableVariables> getApplicableVariables() {
		return applicableVariables;
	}

	public void setApplicableVariables(List<ApprovalCategoryApplicableVariables> applicableVariables) {
