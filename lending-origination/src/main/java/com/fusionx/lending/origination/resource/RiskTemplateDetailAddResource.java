...
public class RiskTemplateDetailAddResource {
	
	@NotBlank(message = "{common.not-null}")
	private String weightagePercentage;
	
	@NotBlank(message = "{common.not-null}")
	@Pattern(regexp = "VARIANCE|VALUE_PAIRE", message = "{indicator-pattern.pattern}")
	...
	@Valid
	private List<RiskTemplateDetailsListAddResource> riskTemplateDetailsList;
	...
	public List<RiskTemplateDetailsListAddResource> getRiskTemplateDetailsList() {
		return riskTemplateDetailsList;
	}

	public void setRiskTemplateDetailsList(List<RiskTemplateDetailsListAddResource> riskTemplateDetailsList) {
