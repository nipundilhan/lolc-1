...
public class DelegationAuthorityGroupAddResource {
	...
	private String noOfMinUsersToBeApproved;
	...
	public String getNoOfMinUsersToBeApproved() {
		return noOfMinUsersToBeApproved;
	}

	public void setNoOfMinUsersToBeApproved(String noOfMinUsersToBeApproved) {
