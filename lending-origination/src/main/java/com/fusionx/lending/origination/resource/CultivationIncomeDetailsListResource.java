...
public class CultivationIncomeDetailsListResource {
	...
	@Valid
	private List<DocumentAddResource> cultivationIncomeDocumentList;

	public List<DocumentAddResource> getCultivationIncomeDocumentList() {
		return cultivationIncomeDocumentList;
	}

	public void setCultivationIncomeDocumentList(List<DocumentAddResource> cultivationIncomeDocumentList) {
