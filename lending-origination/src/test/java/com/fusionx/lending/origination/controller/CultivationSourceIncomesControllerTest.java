...
/**
 * Cultivation Source Incomes Controller Test
 * 
 ********************************************************************************************************
...
public class CultivationSourceIncomesControllerTest {
	@Autowired
    ...
    public void getCultivationIncomeDetailsByIdTest() throws Exception {
        if(size != 0) {
            mockMvc.perform(get("/cultivation-source-incomes/"+ConstantsTest.DEFAULT_TENANT_ID+"/"+id)).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8)).andExpect(status().isOk());
        }else {
            mockMvc.perform(get("/cultivation-source-incomes/"+ConstantsTest.DEFAULT_TENANT_ID+"/"+id)).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8)).andExpect(status().isNoContent());
        }
    }
    ...
    public void getCultivationSourceIncomeDetailsByCultivationIncomeDetailsIdTest() throws Exception {
        if(size != 0) {
            mockMvc.perform(get("/cultivation-source-incomes/"+ConstantsTest.DEFAULT_TENANT_ID+"/cultivation-income-details/"+cultivationIncomeDetailsId)).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8)).andExpect(status().isOk());
        }else {
            mockMvc.perform(get("/cultivation-source-incomes/"+ConstantsTest.DEFAULT_TENANT_ID+"/cultivation-income-details/"+cultivationIncomeDetailsId)).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8)).andExpect(status().isNoContent());
        }
    }
