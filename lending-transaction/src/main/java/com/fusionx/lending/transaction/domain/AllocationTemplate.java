...
@Entity
@Data
@Table(name = "allocation_template")
public class AllocationTemplate extends BaseEntity implements Serializable{
	 
	private static final long serialVersionUID = 5600082090598458454L;
